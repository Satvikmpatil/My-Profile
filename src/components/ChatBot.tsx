  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (lowerInput.includes("contact")) {
        ...
        response =
          "Check out Satvik's GitHub for his latest projects: https://github.com/Satvikmpatil";
      } else if (
        lowerInput.includes("skills") ||
        lowerInput.includes("experience")
      ) {
        response =
          "Satvik specializes in Go, gRPC, PostgreSQL, and Kubernetes for backend, plus React and TypeScript for frontend.";
        ...
        response =
          "Satvik is a software developer specializing in Go backend services, gRPC APIs, and cloud-native technologies.";
      } else if (
        lowerInput.includes("intern") ||
        lowerInput.includes("barracuda")
      ) {
        response =
          "Satvik works as a Software Development Engineer I at Barracuda Networks, building cloud security products with Go and React.";
      } else if (
        lowerInput.includes("education") ||
        lowerInput.includes("college")
      ) {
        response =
          "Satvik completed his B.E. in Computer Science from Basaveshwar Engineering College, Bagalkote.";
      } else if (lowerInput.includes("go") || lowerInput.includes("golang")) {
        response =
          "Satvik builds backend services with Go, using Gin framework, gRPC, PostgreSQL, and Redis. He's also experienced with Docker deployments.";
      }
